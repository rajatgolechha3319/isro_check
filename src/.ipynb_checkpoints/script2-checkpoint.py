...
fits_file_path = 'ch2_cla_l1_20200407T000047620_20200407T000055620.fits'
...
# os.system(f'cp -r {os.path.join(data_dir,fits_file)} .')

spectrumfile = 'ch2_cla_l1_20200407T000047620_20200407T000055620.fits' #os.path.join(data_dir,fits_file)

spec_data = Spectrum('combined_file.fits')
...
# Final Operations
"""
Move the pha files and the arf files in the output folder
